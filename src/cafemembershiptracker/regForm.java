...
public static String hashPass(String password){
    ...
    private void initComponents() {
        ...
        ut.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cafe Attendant", "Customer", "" }));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 80, 33));
